...
# ---------------------------------------------------------------------------
# WAV → preprocess → annotate → export → re-import
# ---------------------------------------------------------------------------
...
class TestCSVRoundtrip:
    ...
    def test_json_roundtrip(self):
        ...
        original = [
            (0.2, 0.8, "Inspiration", "manual"),
            (0.9, 1.5, "Expiration", "auto_accepted"),
            (1.6, 2.0, "Pause", "merged"),
        ]
        anns = [normalize_annotation(a) for a in original]
...
class TestSourceProvenanceRoundtrip:
    ...
    def test_all_sources_survive(self):
        ...
        original = [(i * 0.5, i * 0.5 + 0.4, f"L{i}", src)
