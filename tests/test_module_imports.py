...
EXPECTED_ATTRS = {
    "respanno.labels.events_importer": [
        ("EventsFileIndexer", "function"),  # class are callable
        ("DEFAULT_AUTO_IMPORT_CFG", "dict"),
    ],
    "respanno.labels.annotation_io": [
    ...
    "respanno.ml.label_taxonomy": [
        ("label_kind", "function"),
        ("clear_ml_annotations", "function"),
        ("PHASE_LABELS", "set"),
        ("OTHER_EVENT_LABELS", "set"),
        ("ABNORMAL_SOUND_KIND", "str"),
        ("OTHER_EVENT_KIND", "str"),
        ("PHASE_KIND", "str"),
    ],
    "respanno.ml.phase_model": [
        ("train_phase_model", "function"),
        ("apply_phase_model", "function"),
    ],
    "respanno.ml.classifier": [
        ("train_event_model", "function"),
        ("apply_event_model", "function"),
    ],
    "respanno.ml.frame_labels": [
        ("build_frame_labels", "function"),
        ("get_manual_segments", "function"),
        ("get_reviewed_prefix", "function"),
    ],
}
